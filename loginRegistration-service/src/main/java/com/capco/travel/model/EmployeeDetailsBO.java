...
public class EmployeeDetailsBO implements Serializable {
	...
	public String toString() {
		return "EmployeeDetailsBO [uid=" + uid + ", employeeName=" + employeeName + ", emailId=" + emailId
				+ ", capcoUserId=" + capcoUserId + ", employeeId=" + employeeId + ", employeeMobileNumber="
				+ employeeMobileNumber + ", isApprover=" + isApprover + ", createdOn=" + createdOn + ", modifiedOn="
				+ modifiedOn + ", employeeLocation=" + employeeLocation + ", projectCode=" + projectCode + ", tokenId="
				+ tokenId + ", grade=" + grade + "]";
	}
