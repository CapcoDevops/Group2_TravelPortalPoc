...
public class LoginDetailsBO implements Serializable{
	...
	public String toString() {
		return "LoginDetailsBO [uid=" + uid + ", capcoUserId=" + capcoUserId + ", employoeeId=" + employoeeId
				+ ", employeeName=" + employeeName + ", grade=" + grade + ", contactNumber=" + contactNumber
				+ ", password=" + password + ", approverId=" + approverId + ", isActive=" + isActive + ", emailId="
				+ emailId + "]";
	}
